...
export default function UbahBahasa() {
  ...
  const handleLanguageChange = (lang: string) => {
    if (selectedLang === lang) { setShowWarningModal(true); return; }
  ...
  return (
    <>
      ...
      >
        <View style={{ flex: 1 }}>
          {[
            { lang: "ID", uri: "https://flagcdn.com/w80/id.png", label: "Indonesia" },
            { lang: "EN", uri: "https://flagcdn.com/w80/gb.png", label: "English" },
          ].map(({ lang, uri, label }) => (
      ...
      <Modal visible={showSuccessModal} transparent animationType="fade">
        <Pressable style={styles.modalOverlay} onPress={() => setShowSuccessModal(false)}>
          <View style={styles.infoCard}>
            <Ionicons name="checkmark-circle" size={50} color="#1E6F9F" style={styles.modalIcon} />
            <Text style={styles.infoTitle}>Berhasil</Text>
            <Text style={styles.infoDesc}>
              Bahasa aplikasi telah berhasil diubah ke {selectedLang === "ID" ? "Indonesia" : "English"}.
            </Text>
            <TouchableOpacity style={styles.infoButton} onPress={() => setShowSuccessModal(false)}>
      ...
      <Modal visible={showWarningModal} transparent animationType="fade">
        <Pressable style={styles.modalOverlay} onPress={() => setShowWarningModal(false)}>
          <View style={styles.infoCard}>
            <Ionicons name="alert-circle" size={50} color="#E11D48" style={styles.modalIcon} />
            ...
            <TouchableOpacity style={styles.infoButtonError} onPress={() => setShowWarningModal(false)}>
