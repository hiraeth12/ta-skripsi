...
export default function UbahLokasi() {
  ...
  const handleUseGPS = async () => {
    ...
    try {
      ...
      if (err?.message === "GPS timeout") {
        ...
        showCustomAlert(t("ubahLokasiScreen.alert.errorTitle"), t("ubahLokasiScreen.alert.gpsErrorMsg"), "error");
      }
    } finally {
      setGpsLoading(false);
    }
  ...
  const handleSimpan = async () => {
    if (!selectedLocationItem) {
      showCustomAlert(t("ubahLokasiScreen.alert.errorTitle"), t("ubahLokasiScreen.alert.saveErrorNoLocationMsg"), "error");
      return;
    }
    ...
    try {
      ...
      showCustomAlert(t("ubahLokasiScreen.alert.errorTitle"), t("ubahLokasiScreen.alert.saveErrorDbMsg"), "error");
      return;
    }
